        ...
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          <div className="flex lg:items-center lg:gap-8 xl:gap-32.5">
            <div className=" md:w-1/2">
              ...
              <p>
                Website ini dirancang untuk memperkenalkan berbagai fasilitas, kegiatan
                penelitian, dan layanan unggulan yang tersedia di Laboratorium Gedung Grafika Sekolah Vokasi UGM.
              </p>

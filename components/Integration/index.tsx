    ...
    <>
      <section>
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <SectionHeader
            headerInfo={{
              title: `TRE UGM LABORATORIES`,
              subtitle: `Fasilitas Laboratorium Modern untuk Penelitian dan Inovasi.`,
              description: `Laboratorium Universitas Gadjah Mada menyediakan berbagai fasilitas modern untuk mendukung penelitian mahasiswa, dosen, dan kolaborasi dengan mitra global. Akses data dan kelola proyek Anda kapan saja dan di mana saja.`,
            }}
          />
